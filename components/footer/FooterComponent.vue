<template>
  ...
  <footer class="br-footer">
    <div class="container-lg">
      <div class="logo">
        <img src="https://cdngovbr-ds.estaleiro.serpro.gov.br/design-system/images/logo-negative.png" alt="Imagem" />
      </div>
      <div class="br-list horizontal" data-toggle="data-toggle" data-sub="data-sub">
        <div class="col-2">
          ...
          <div class="br-list">
            <span class="br-divider d-md-none">
            </span>
        ...
        <div class="col-2">
          ...
          <div class="br-list">
            ...
            <a class="br-item" href="javascript:void(0)">
              <div class="content">Adipisicing culpa et ad consequat Adipisicing culpa et ad consequat</div>
            </a>
            <a class="br-item" href="javascript:void(0)">
              <div class="content">Nulla occaecat eiusmod</div>
            </a>
      ...
      <div class="d-none d-sm-block">
        <div class="row align-items-end justify-content-between py-5">
          <div class="col social-network">
            ...
            <a class="mr-3" href="https://www.facebook.com/UFCatalao">
              <span class="fab fa-facebook "></span>
            </a>
            <a class="mr-3" href="https://www.instagram.com/ufcatalao/">
              <span class="fab fa-instagram">
              </span></a>
            <a class="mr-3" href="https://www.youtube.com/c/UniversidadeFederaldeCatal%C3%A3oUFCAT">
