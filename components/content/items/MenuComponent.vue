                ...
                <nav class="menu-body">
                    ...
                    <div class="menu-folder">
                        <a class="menu-item" href="javascript: void(0)">
                            ...
                            <span class="content">Nível1 </span>
                        </a>
                        <ul>
                            <li>
                                <a class="menu-item" href="javascript: void(0)">
                            ...
                            <li>
                                <a class="menu-item" href="javascript: void(0)">
                                    ...
                                    <span class="content">Nível2</span>
                                </a>
                                <ul>
                                    <li>
                                        <a class="menu-item" href="javascript: void(0)">
                ...
                <div class="menu-footer">
                    ...
                    <div class="menu-links">
                        <a href="javascript: void(0)">
                            <span class="mr-1">Link externo
                                1</span>
                            <i class="fas fa-external-link-square-alt" aria-hidden="true">
                            </i>
                        </a>
                        <a href="javascript: void(0)">
