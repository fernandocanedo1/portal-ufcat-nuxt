<template>
    <div class="row mb-md-2">
        <div class="col-md-6 col-lg-4">
            <div class="br-card  " id="link-card" onclick="window.location='http://example.com';">
                ...
                <div class="tile-subtitle">
                    ...
                    <h5 class="font-weight-normal">Publicado Edital da Eleição de Representantes nas Instâncias
                        Deliberativas da UFCAT</h5>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="br-card  ">
                ...
                <div class="tile-subtitle">
                    <a href="#">
                        <h5 class="font-weight-normal">Retorno das atividades do TRAVESSIA: Grupo de Acolhimento de
                            estudantes de graduação</h5>
                    </a>
